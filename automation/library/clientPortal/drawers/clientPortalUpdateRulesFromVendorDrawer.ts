...
export class ClientPortalUpdateRulesFromVendorDrawer extends ClientPortalBase {
  ...
  constructor(global: ClientPortalGlobal, vendor: Vendor) {
    ...
    this.Title = new Element(
      global.page,
      this.parent.getByText(DrawerStrings.UpdateRulesFromVendor_Title),
      DrawerStrings.UpdateRulesFromVendor_Title
    )
    ...
    this.Button_Close = new Element(
      global.page,
      this.parent.locator('#drawer_serviceareavendorupdaterules_close')
    )
    this.Button_Submit = new Element(
      global.page,
      this.page.locator('#updateServiceAreaVendorRulesForm-submit'),
      DrawerStrings.Button_Submit
    )
    this.Label_SelectRules = new Element(
      global.page,
      this.parent.locator('#updateServiceAreaVendorRulesForm div.chakra-alert__title'),
      DrawerStrings.UpdateRulesFromVendor_Label_SelectRules
    )
    this.Label_SelectRulesDescription = new Element(
      global.page,
      this.parent.locator('#updateServiceAreaVendorRulesForm div.chakra-alert__desc'),
      DrawerStrings.UpdateRulesFromVendor_Label_SelectRulesDescription
    )
  ...
  async SelectAllRules() {
    await this.page
      .locator('#updateServiceAreaVendorRulesForm div[role="group"] > div > label')
      .nth(0)
      .setChecked(true)
  }
  ...
  async LoadRuleSet() {
    const checkboxLocator = this.page.locator(
      '#updateServiceAreaVendorRulesForm div[role="group"] > div > label'
    )
