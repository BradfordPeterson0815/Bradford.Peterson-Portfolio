...
test.describe(
  'Inbox Page',
  {
    tag: [Tags.Delegate, Tags.Subcontractor, Tags.Job, Tags.Inbox],
  },
  () => {
    ...
    test('Verify Navigation and UI Elements', async ({ browser }) => {
      ...
      if ((await inboxPage.MessageCount()) > 0) {
        ...
        const messagingCategories: string[] = ['Messaging - Assignments', 'Messaging - Claims']
        ...
        const messagingDetails: string[] = [
          `You've been set as a Subcontractor for`,
          'Estimate for ',
