...
import { FileCardStrings } from './delegatePortalConstants.js'
import { DelegatePortalGlobal } from './delegatePortalGlobal.js'
import { DelegatePortalFileCardImageZoomDialog } from './dialogs/delegatePortalFileCardImageZoomDialog.js'
import { DelegatePortalBase } from './pages/delegatePortalBase.js'

export class DelegatePortalFileCard extends DelegatePortalBase {
  ...
  constructor(global: DelegatePortalGlobal, fileCardParent: Locator, cardIndex: number) {
    super(global)
  ...
  async Zoom() {
    ...
    const fileName = (await this.label_FileName.textContent()) || ''
    return new DelegatePortalFileCardImageZoomDialog(this.global, fileName)
  }
