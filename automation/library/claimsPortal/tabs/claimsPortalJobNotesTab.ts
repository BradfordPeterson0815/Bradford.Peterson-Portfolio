...
export class ClaimsPortalJobNotesTab extends ClaimsPortalBasePage {
  ...
  constructor(global: ClaimsPortalGlobal, job: ClaimsPortalJob, jobPageURL: string) {
    ...
    this.Label_NoNotesHaveBeenAdded_Title = new Element(
      ...
      this.parent.getByRole('heading', {
        name: NotesTabStrings.Label_NoNotesHaveBeenAdded_Title,
      })
    )
  ...
  async OpenFilterNotes() {
    await this.Button_FilterNotes.locator.click({ force: true })
