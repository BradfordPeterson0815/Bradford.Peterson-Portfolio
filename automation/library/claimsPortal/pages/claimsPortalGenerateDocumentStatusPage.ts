...
import { GenerateDocumentStatusPageStrings } from '../claimsPortalConstants.js'

export class ClaimsPortalGenerateDocumentStatusPage extends ClaimsPortalBasePage {
