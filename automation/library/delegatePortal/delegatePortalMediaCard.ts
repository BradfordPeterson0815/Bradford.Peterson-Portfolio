...
import { MediaCardStrings } from './delegatePortalConstants.js'
...
export class DelegatePortalMediaCard extends DelegatePortalBase {
  ...
  constructor(global: DelegatePortalGlobal, cardIndex: number) {
    super(global)
