...
import { delegate, delegatePortalFieldTech } from '../../environments/env.ceylon.js'
import {
  DefaultEnvironment,
...
const authFile = delegatePortalFieldTech.AUTH_STORAGE_PATH
const environment = DefaultEnvironment

setup.use({ storageState: authFile })
setup('AuthenticateDelegateFieldTechAsNeeded', async ({ browser }) => {
