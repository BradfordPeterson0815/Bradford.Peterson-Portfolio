...
test.describe(
  ...
  {
    tag: [Tags.Delegate, Tags.InspectionTech, Tags.Claim, Tags.Inspection, Tags.InfoDetails],
  },
  () => {
    ...
    test('Inspection Screenshots Table - Settings: Verify UI', async ({ browser }) => {
      ...
      await inspectionDetailsTab.NavigateDirectly(testClaim.testData.claimInspectionSuffixAlt)
      const table = inspectionDetailsTab.DataTable_InspectionScreenshots
