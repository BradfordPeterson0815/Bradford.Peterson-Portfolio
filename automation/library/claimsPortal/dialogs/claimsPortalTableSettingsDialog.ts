...
export class ClaimsPortalTableSettingsDialog extends ClaimsPortalBase {
  ...
  async VerifyColumnExists(column: DataTable_Columns_Type) {
    ...
    expect((await columnLocator.count()) > 0).toBe(true)
  }
