...
import { NoteDataSourceTuples, NoteDataSources } from './delegatePortalConstants.js'
import { DelegatePortalGlobal } from './delegatePortalGlobal.js'
import { DelegatePortalBase } from './pages/delegatePortalBase.js'
import { DelegatePortalExportNoteDrawer } from './drawers/delegatePortalExportNoteDrawer.js'

export class DelegatePortalNote extends DelegatePortalBase {
  ...
  constructor(global: DelegatePortalGlobal, main: Locator, dateParent: Locator) {
    super(global)
  ...
  async OpenExportNoteDrawer() {
    ...
    return new DelegatePortalExportNoteDrawer(this.global)
  }
}
