...
import { VendorRatesTemplateDetailPage } from '../claimsPortalConstants.js'
...
export class ClaimsPortalVendorRatesTemplateDetailPage extends ClaimsPortalBasePage {
  ...
  readonly Button_EditTemplateRates: Element
  ...
  constructor(global: ClaimsPortalGlobal, vendorRates: ClaimsPortalVendorRates) {
    ...
    this.Button_BackToVendorRates = new Element(
      ...
      VendorRatesTemplateDetailPage.Button_BackToVendorRates
    )
    this.Label_Badge = new Element(
      global.page,
      this.headerParent.locator('span.chakra-badge'),
      VendorRatesTemplateDetailPage.Badge_Template
    )
    this.Button_EditTemplateRates = new Element(
      global.page,
      this.headerParent.locator('div > button').nth(0),
      VendorRatesTemplateDetailPage.Button_EditTemplateRates
    )
    ...
    this.Label_RatesInfo_Title = new Element(
      ...
      VendorRatesTemplateDetailPage.Title_RatesInfo
    )

    this.Label_MechanicalTarpingRates_Title = new Element(
      global.page,
      this.page.locator('div[id$="_content"] h3').nth(0),
      VendorRatesTemplateDetailPage.Title_MechanicalTarpingRates
    )
    ...
    this.Label_MechanicalTarpingRates_DuringBusinessHours = new Element(
      ...
      this.page
        ...
        .locator(' dl')
        .nth(0)
        .getByText(VendorRatesTemplateDetailPage.Label_MechanicalTarpingRates_DuringBusinessHours, {
          exact: true,
        }),
      VendorRatesTemplateDetailPage.Label_MechanicalTarpingRates_DuringBusinessHours
    )
    ...
    this.Label_MechanicalTarpingRates_AfterBusinessHours = new Element(
      ...
      this.page
        ...
        .locator(' dl')
        .nth(0)
        .getByText(VendorRatesTemplateDetailPage.Label_MechanicalTarpingRates_AfterBusinessHours, {
          exact: true,
        }),
      VendorRatesTemplateDetailPage.Label_MechanicalTarpingRates_AfterBusinessHours
    )
    ...
    this.Label_MechanicalTarpingRates_MaterialCost = new Element(
      ...
      this.page
        ...
        .locator(' dl')
        .nth(0)
        .getByText(VendorRatesTemplateDetailPage.Label_MechanicalTarpingRates_MaterialCost, {
          exact: true,
        }),
      VendorRatesTemplateDetailPage.Label_MechanicalTarpingRates_MaterialCost
    )
    ...
    this.Label_SandbagTarpingRates_Title = new Element(
      ...
      VendorRatesTemplateDetailPage.Title_SandbagTarpingRates
    )
    ...
    this.Label_SandbagTarpingRates_DuringBusinessHours = new Element(
      ...
      this.page
        ...
        .locator(' dl')
        .nth(1)
        .getByText(VendorRatesTemplateDetailPage.Label_SandbagTarpingRates_DuringBusinessHours, {
          exact: true,
        }),
      VendorRatesTemplateDetailPage.Label_SandbagTarpingRates_DuringBusinessHours
    )
    ...
    this.Label_SandbagTarpingRates_AfterBusinessHours = new Element(
      ...
      this.page
        ...
        .locator(' dl')
        .nth(1)
        .getByText(VendorRatesTemplateDetailPage.Label_SandbagTarpingRates_AfterBusinessHours, {
          exact: true,
        }),
      VendorRatesTemplateDetailPage.Label_SandbagTarpingRates_AfterBusinessHours
    )
    ...
    this.Label_SandbagTarpingRates_MaterialCost = new Element(
      ...
      this.page
        ...
        .locator(' dl')
        .nth(1)
        .getByText(VendorRatesTemplateDetailPage.Label_SandbagTarpingRates_MaterialCost, {
          exact: true,
        }),
      VendorRatesTemplateDetailPage.Label_SandbagTarpingRates_MaterialCost
    )
