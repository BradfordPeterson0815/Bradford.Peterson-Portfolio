...
export class ClaimsPortalMakeMediasVisibleToAdditionalGroupsDrawer extends ClaimsPortalBase {
  ...
  constructor(global: ClaimsPortalGlobal) {
    ...
    const titleText = DrawerStrings.MakeMediasVisibleToAdditionalGroups_Title
