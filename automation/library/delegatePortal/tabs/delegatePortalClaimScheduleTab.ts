...
import { DelegatePortalCancelInspectionDrawer } from '../drawers/delegatePortalCancelInspectionDrawer.js'
import { DelegatePortalCompleteInspectionDrawer } from '../drawers/delegatePortalCompleteInspectionDrawer.js'
import { DelegatePortalScheduleInspectionDrawer } from '../drawers/delegatePortalScheduleInspectionDrawer.js'
import { DelegatePortalClaim } from '../delegatePortalClaim.js'
import { DateDirection, ClaimScheduleTabStrings, Months } from '../delegatePortalConstants.js'
...
export class DelegatePortalClaimScheduleTab extends DelegatePortalBasePage {
  ...
  constructor(global: DelegatePortalGlobal, claim: DelegatePortalClaim, claimPageURL: string) {
    ...
    this.Title = new Element(
      ...
      this.page.getByRole('heading', {
        name: `${ClaimScheduleTabStrings.Title_InspectionsSchedule}`,
      }),
      ClaimScheduleTabStrings.Title_InspectionsSchedule
    )
    this.Button_ScheduleInspection = new Element(
      global.page,
      this.page.getByRole('button', { name: ClaimScheduleTabStrings.Button_ScheduleInspection }),
      ClaimScheduleTabStrings.Button_ScheduleInspection
    )
    this.Button_Previous = new Element(
      global.page,
      this.page.getByRole('button', { name: ClaimScheduleTabStrings.Button_Previous }),
      ClaimScheduleTabStrings.Button_Previous
    )
    this.Button_Next = new Element(
      global.page,
      this.page.getByRole('button', { name: ClaimScheduleTabStrings.Button_Next }),
      ClaimScheduleTabStrings.Button_Next
    )
    this.Label_CurrentMonth = new Element(
      global.page,
      this.page.locator(
        '#root div.chakra-card__body > div > div:nth-child(2) > div:nth-child(1) > p[title="Current Month"]'
      )
    )
  }
  ...
  async OpenScheduleInspectionDrawer() {
    ...
    const scheduleInspectionDrawer = new DelegatePortalScheduleInspectionDrawer(this.global)
  ...
  async OpenCancelInspectionDrawer(actionsButton: Locator) {
    ...
    const cancelInspectionDrawer = new DelegatePortalCancelInspectionDrawer(this.global)
  ...
  async OpenCompleteInspectionDrawer(actionsButton: Locator) {
    ...
    const completeInspectionDrawer = new DelegatePortalCompleteInspectionDrawer(this.global)
