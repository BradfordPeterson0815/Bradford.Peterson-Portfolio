...
export class DelegatePortalClaimNotesTab extends DelegatePortalBasePage {
  ...
  constructor(global: DelegatePortalGlobal, claim: DelegatePortalClaim, claimPageURL: string) {
    ...
    this.Label_NoNotesHaveBeenAdded_Title = new Element(
      ...
      this.parent.getByRole('heading', {
        name: ClaimNotesTabStrings.Label_NoNotesHaveBeenAdded_Title,
      })
    )
  ...
  async OpenCreateNoteDrawer() {
    ...
    const drawer = new DelegatePortalCreateNoteDrawer(this.global)
