...
import { UserPortalFileCardImageZoomDialog } from './dialogs/userPortalFileCardImageZoomDialog.js'
import { UserPortalBase } from './pages/userPortalBase.js'
import { FileCardStrings } from './userPortalConstants.js'
import { UserPortalGlobal } from './userPortalGlobal.js'

export class UserPortalFileCard extends UserPortalBase {
  ...
  constructor(global: UserPortalGlobal, fileCardParent: Locator, cardIndex: number) {
    super(global)
  ...
  async Zoom() {
    ...
    const fileName = (await this.label_FileName.textContent()) || ''
    return new UserPortalFileCardImageZoomDialog(this.global, fileName)
  }
