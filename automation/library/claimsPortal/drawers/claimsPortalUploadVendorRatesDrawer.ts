...
export class ClaimsPortalUploadVendorRatesDrawer extends ClaimsPortalBase {
  readonly Title: Element
  readonly Description: Element
  readonly Button_Close_X: Element
  readonly Button_Close: Element
  readonly Button_Submit: Element
  readonly Button_DownloadVendorRatesCSV: Element
  ...
  constructor(global: ClaimsPortalGlobal) {
    ...
    this.Title = new Element(
      global.page,
      this.parent.getByText(DrawerStrings.UploadVendorRatesCSV_Title),
      DrawerStrings.UploadVendorRatesCSV_Title
    )
    this.Description = new Element(
      global.page,
      this.parent.getByText(DrawerStrings.UploadVendorRatesCSV_Description),
      DrawerStrings.UploadVendorRatesCSV_Description
    )
    this.Button_Close_X = new Element(
      global.page,
      this.parent.locator(`button[aria-label='Close']`)
    )
    this.Button_DownloadVendorRatesCSV = new Element(
      global.page,
      this.parent.getByRole('button', {
        name: DrawerStrings.UploadVendorRatesCSV_Button_DownloadVendorRatesCSV,
      }),
      DrawerStrings.UploadVendorRatesCSV_Button_DownloadVendorRatesCSV
    )
    ...
    this.Button_RemoveAllFiles = new Element(
      global.page,
      this.parent.getByRole('button', {
        name: `${DrawerStrings.UploadVendorRatesCSV_Button_RemoveAllFiles}`,
      }),
      DrawerStrings.UploadVendorRatesCSV_Button_RemoveAllFiles
    )
  }
  ...
  async UploadInvalidVendorRatesFileType() {
  ...
  async UploadInvalidVendorRatesCSV() {
    const fullFileName = 'InvalidVendorRates.csv'
    const fullPathToFile = this.global.uploadFolder + '//' + fullFileName
    await this.UploadSingleFile(fullPathToFile)
