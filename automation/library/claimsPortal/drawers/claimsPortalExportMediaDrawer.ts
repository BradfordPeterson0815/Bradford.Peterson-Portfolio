...
export class ClaimsPortalExportMediaDrawer extends ClaimsPortalBase {
  ...
  constructor(global: ClaimsPortalGlobal, expectedMediaCount: string) {
    super(global)
    this.parent = this.page.locator('div[role="dialog"]')

    const titleText = DrawerStrings.ExportMedia_Title.replace('<NUMBER>', expectedMediaCount)
