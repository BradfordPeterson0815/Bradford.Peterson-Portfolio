...
import { delegate, delegatePortalInspectionTech } from '../../environments/env.ceylon.js'
import {
  DefaultEnvironment,
...
const authFile = delegatePortalInspectionTech.AUTH_STORAGE_PATH
const environment = DefaultEnvironment

setup.use({ storageState: authFile })
setup('AuthenticateDelegateInspectionTechAsNeeded', async ({ browser }) => {
